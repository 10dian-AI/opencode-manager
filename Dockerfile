...
# Install python3 for account HTTP automation scripts.
...
COPY --from=builder --chown=bun:bun /app/server/utils/cancel_autorenew.py ./server/utils/cancel_autorenew.py
